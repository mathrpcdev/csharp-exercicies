...
class testandoCondicionais
{
    ...
    {
        /* Neste challenge utilizo estruturas de decisão e interpolação para uso das variáveis no Console.WriteLine.
        ...
        ** USE O OPERADOR CONDICIONAL QUANDO PRECISAR ADICIONAR A LÓGICA DE RAMIFICAÇÃO INLINE. ** */
        ...
        Console.WriteLine($"***** ESTRUTURAS DE DECICSÃO PARA AVALIAR SE NUMBER1 É > QUE NUMBER2, VIVE-VERSA. *****\n");
        ...
        Console.WriteLine($"***** ABAIXO SEGUE O MESMO EXERCÍCIO, MAS UTILIZANDO OPERADORES CONDICIONAIS - TERNÁRIOS. *****\n");
        //  >1000 = 100 ? <1000 : 50;
